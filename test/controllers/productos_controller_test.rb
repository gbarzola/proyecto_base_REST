...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descripcion_producto: @producto.descripcion_producto, id_producto: @producto.id_producto, precio_producto: @producto.precio_producto, stockCrear: @producto.stockCrear }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { descripcion_producto: @producto.descripcion_producto, id_producto: @producto.id_producto, precio_producto: @producto.precio_producto, stockCrear: @producto.stockCrear }
    assert_redirected_to producto_path(assigns(:producto))
  end
